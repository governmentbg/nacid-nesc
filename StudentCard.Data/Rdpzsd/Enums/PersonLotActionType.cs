...
namespace StudentCard.Data.Rdpzsd.Enums
{
    ...
    public enum PersonLotActionType
    {
        ...
        [Description("Добавяне на преиздадена диплома към специалност")]
        PersonStudentDuplicateDiplomaAdd = 36,

        [Description("Редакция на преиздадена диплома към специалност")]
        PersonStudentDuplicateDiplomaEdit = 37,

        [Description("Изпратен за стикер на преиздадена диплома")]
        SendDuplicateForSticker = 38,

        [Description("Стикер за печат на преиздадена диплома")]
        StickerForPrintDuplicate = 39,

        [Description("Получен стикер на преиздадена диплома")]
        RecievedDuplicateSticker = 40,

        [Description("Невалидна преиздадена диплома към специалност")]
